...
// Otomatis '/' di Vercel, '/HSK_1to5_study-simulation/' di GitHub Pages
// Atur VITE_BASE_URL di .env sesuai kebutuhan
const basename = import.meta.env.VITE_BASE_URL ?? '/'

// Layout untuk semua halaman protected
  ...
  return (
    <BrowserRouter basename={basename}>
      <Routes>
        ...
        {/* Protected — semua pakai ProtectedLayout */}
